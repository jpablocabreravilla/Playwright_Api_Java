...
import request.ProductoRequests;
import utilities.BaseTest;

public class ProductoTests extends BaseTest {

    private ProductoRequests productoRequests;
    ...
    public void obtenerProductosTest() {
        response = productoRequests.obtenerProductos(requestOptions);
    ...
    public void obtenerProductoTest() {
        response = productoRequests.obtenerProducto(2, requestOptions);
        Assertions.assertEquals(200, response.status());
    }
...
/*  @Test
    ...
    @Test
    @Regression
    public void obtenerProductoTestAssertions() {
        response = productoRequests.obtenerProducto(2, requestOptions);
        Assertions.assertEquals(200, response.status());
        ...
        Assertions.assertAll(
                ...
                () -> Assertions.assertEquals("Papas fritas", producto.nombre()),
                () -> Assertions.assertEquals(15.699, producto.precio()),
                ...
                () -> Assertions.assertEquals("Antojos", producto.etiquetas().get(3))
        );
    }
    ...
    public void eliminarProductoTest() {
        response = productoRequests.eliminarProducto(2, requestOptions);
        Assertions.assertEquals(200, response.status());
    }

    @Test
    @Regression
    public void ordenarProductosTest() {
    ...
    @Test
    @Regression
    public void filtrarProductosTest() {
    ...
    public void crearProductoTest() {
        ...
        response = productoRequests.crearProducto(requestOptions);
    ...
    public void actualizarProductoTest() {
        ...
        requestOptions.setData(requestBody);
        requestOptions.setHeader("Content-Type", "application/json");
        response = productoRequests.actualizarProducto(2, requestOptions);
        Assertions.assertEquals(200, response.status());
    }

    @Test
    @Regression
    public void actualizarParcialmenteProductoTest() {
        final var requestBody = """
                {
                    "nombre": "Blass",
                    "precio": 4.892,
        ...
        requestOptions.setData(requestBody);
        requestOptions.setHeader("Content-Type", "application/json");
        response = productoRequests.actualizarParcialmentePoducto(2, requestOptions);
        Assertions.assertEquals(200, response.status());
    }
